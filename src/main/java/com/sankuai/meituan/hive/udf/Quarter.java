 ...
 * UDFQuarter
 */
@Description(name = "quarter", value = "_FUNC_(date or timestamp) -" + " Returns the quarter of the year corresponding to date or timestamp")
public class Quarter extends UDF {
     ...
     *
     * @param dateTimeStamp the dateTimeStamp in the format of "yyyy-MM-dd HH:mm:ss" or
     *                      "yyyy-MM-dd".
